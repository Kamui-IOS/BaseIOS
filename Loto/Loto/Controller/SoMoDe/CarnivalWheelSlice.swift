...
//  Loto
//
//  Created by Nam Hoang Van on 9/22/20.
...
public class CarnivalWheelSlice: FortuneWheelSliceProtocol {
    ...
    public var font: UIFont {
        switch style {
        case .brickRed: return UIFont(name: "ChunkFive", size: 30.0)!
        case .sandYellow: return UIFont(name: "Lobster 1.3", size: 30.0)!
        case .babyBlue: return UIFont(name: "Phosphate", size: 30.0)!
        case .deepBlue: return UIFont(name: "Bebas", size: 30.0)!
        }
    }
