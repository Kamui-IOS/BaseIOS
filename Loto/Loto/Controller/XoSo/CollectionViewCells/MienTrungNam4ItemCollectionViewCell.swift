//
//  MienTrungNam4ItemCollectionViewCell.swift
//  Loto
//
...
class MienTrungNam4ItemCollectionViewCell: UICollectionViewCell {
    ...
    @IBOutlet weak var g6_014: UILabel!
    @IBOutlet weak var g6_024: UILabel!
    @IBOutlet weak var g6_034: UILabel!
    
    @IBOutlet weak var g5_01: UILabel!
    @IBOutlet weak var g5_02: UILabel!
    @IBOutlet weak var g5_03: UILabel!
    @IBOutlet weak var g5_04: UILabel!
    ...
    @IBOutlet weak var g4_041: UILabel!
    @IBOutlet weak var g4_042: UILabel!
    @IBOutlet weak var g4_043: UILabel!
    @IBOutlet weak var g4_044: UILabel!
    @IBOutlet weak var g4_045: UILabel!
    @IBOutlet weak var g4_046: UILabel!
    @IBOutlet weak var g4_047: UILabel!
    ...
    func loadCell(date: String, data: [Jackport]) {
        ...
        self.dataLoto04.append(contentsOf: data[3].second ?? [])
        ...
        self.dataLoto04.append(contentsOf: data[3].third ?? [])
        ...
        self.dataLoto04.append(contentsOf: data[3].fourth ?? [])
        ...
        self.dataLoto04.append(contentsOf: data[3].fiveth ?? [])
        ...
        self.dataLoto04.append(contentsOf: data[3].sixth ?? [])
        ...
        self.dataLoto04.append(contentsOf: data[3].seventh ?? [])
        
        self.dataLoto01.append(data[0].eighth ?? "")
        self.dataLoto02.append(data[1].eighth ?? "")
        self.dataLoto03.append(data[2].eighth ?? "")
        self.dataLoto04.append(data[3].eighth ?? "")
        
        self.loto(array01: dataLoto01, array02: dataLoto02, array03: dataLoto03, array04: dataLoto04)
        ...
        if let data_seventh = data[3].seventh {
            self.g7_04.text = data_seventh[0]
        }
        ...
        if let data_fiveth = data[3].fiveth {
            self.g5_04.text = data_fiveth[0]
        }
        ...
        if let data_fourth = data[3].fourth {
            self.g4_041.text = data_fourth[0]
            self.g4_042.text = data_fourth[1]
            self.g4_043.text = data_fourth[2]
            self.g4_044.text = data_fourth[3]
            self.g4_045.text = data_fourth[4]
            self.g4_046.text = data_fourth[5]
        }
        ...
        if let data_third = data[3].third {
            self.g3_041.text = data_third[0]
            self.g3_042.text = data_third[1]
        }
        ...
        if let data_second = data[3].second {
            self.g2_04.text = data_second[0]
        }
        
        self.g1_01.text = data[0].first
        self.g1_02.text = data[1].first
        self.g1_03.text = data[2].first
        self.g1_04.text = data[3].first
        
        self.db_01.text = data[0].jackport
        self.db_02.text = data[1].jackport
        self.db_03.text = data[2].jackport
        self.db_04.text = data[3].jackport
    }

    
    func loto(array01: [String], array02: [String], array03: [String], array04: [String]) {
        for str in array01 {
    ...
    func showFoot04(data: [DauDuoiLoto]) {
        self.dau_04.text = getDataLoto(isCheck: false, data: data, dataCheck: "0")
        self.dau_14.text = getDataLoto(isCheck: false, data: data, dataCheck: "1")
        self.dau_24.text = getDataLoto(isCheck: false, data: data, dataCheck: "2")
        self.dau_34.text = getDataLoto(isCheck: false, data: data, dataCheck: "3")
        self.dau_44.text = getDataLoto(isCheck: false, data: data, dataCheck: "4")
        self.dau_54.text = getDataLoto(isCheck: false, data: data, dataCheck: "5")
        self.dau_64.text = getDataLoto(isCheck: false, data: data, dataCheck: "6")
        self.dau_74.text = getDataLoto(isCheck: false, data: data, dataCheck: "7")
        self.dau_84.text = getDataLoto(isCheck: false, data: data, dataCheck: "8")
        self.dau_94.text = getDataLoto(isCheck: false, data: data, dataCheck: "9")
    }
